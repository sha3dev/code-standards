...
export async function verifyTooling(targetPath, contract, packageJson, options = {}) {
  ...
  if (activeRuleIds.has("package-exports-alignment") && shouldRunRule(options.onlyRuleIds, "package-exports-alignment")) {
    ...
    if (
      !biomeRaw.includes('"lineWidth": 160') ||
      !biomeRaw.includes('"quoteStyle": "double"') ||
      !biomeRaw.includes('"noUnusedVariables": "error"') ||
      !biomeRaw.includes('"noUnusedFunctionParameters": "error"') ||
      !biomeRaw.includes('"noUnusedPrivateClassMembers": "error"') ||
      !biomeRaw.includes('"noUnusedImports": "error"')
    ) {
