...
export function printInitGuidance(targetPath) {
  ...
  printIndentedLines([
    ...
    "3. Open PROMPT.md in the project root and complete the final Implementation Request section.",
    "4. Paste the full contents of PROMPT.md into your LLM.",
    "5. Tell the LLM to execute npm run check itself and fix any failures before finishing.",
    "6. Implement the feature without editing managed files unless this is a standards update.",
  ]);
}
