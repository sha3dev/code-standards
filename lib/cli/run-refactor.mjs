...
import { pathExists, runCommand } from "../utils/fs.mjs";
...
async function ensureDependenciesInstalled(targetPath, installRequested) {
...
export async function runRefactor(rawOptions) {
  ...
  await ensureDependenciesInstalled(targetPath, rawOptions.install);
