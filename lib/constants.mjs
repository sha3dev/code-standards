...
export const CONTRACT_FORMAT_VERSION = "v1";
export const NODE_LIB_REFRESH_SIGNATURE = { main: "dist/index.js", types: "dist/index.d.ts" };
...
export const README_REQUIRED_HEADINGS = [
  "## TL;DR",
  "## Installation",
  "## Compatibility",
  "## Public API",
...
export const MANAGED_AI_FILES = ["AGENTS.md", "ai/contract.json"];
